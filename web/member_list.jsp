...
<body>
        ...
        <div class="content">
            ...
            <div class="toolbar">
                <div class="toolbar-left">
                    <form method="get" action="members" class="search-group">
                    ...
                    <c:if test="${action == 'search'}">
                        <a href="members" style="font-size:13px;color:#4a90d9;text-decoration:none;">✕ Xóa lọc</a>
                    </c:if>
                </div>
                <a href="members?action=add" class="btn-add">➕ Thêm thành viên</a>
            </div>
                                ...
                                <c:forEach var="m" items="${memberList}" varStatus="idx">
                                    <tr>
                                        ...
                                        <td style="text-align:center;white-space:nowrap;">
                                            <a href="members?action=edit&id=${m.memberID}" class="btn-edit">✏️ Sửa</a>
                                            &nbsp;
    ...
    <script>
        function confirmDelete(id, name) {
            ...
            document.getElementById('deleteConfirmLink').href = 'members?action=delete&id=' + id;
